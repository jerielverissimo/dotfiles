...
;                        before-init (fn [params]
;                                      (set params.workDoneToken :1))
;             flutter-tools (require :flutter-tools)]
;         ;; To add support to more language servers check:
;         ;; https://github.com/neovim/nvim-lspconfig/blob/master/doc/server_configurations.md
;
;         (vim.lsp.config :* {:on_attach on-attach
;                             :handlers handlers
...
;         ;                   :capabilities capabilities})
;         ;; Rust
;         (rust-tools.setup {:server {:on_attach on-attach}})
;
;         ;; Flutter
;         (flutter-tools.setup {:lsp {:color {:enable true} :on_attach on-attach}})
;
;         ;; Fennel
...
;         ;                   :capabilities capabilities})
;         ;; Odin
;         ; (lsp.ols.setup {:on_attach    on-attach
;         ;                       :handlers     handlers
;         ;                       :before_init  before-init
;         ;                       :capabilities capabilities})
;
;
;         ;; Harper
;         ; (lsp.harper_ls.setup {:on_attach    on-attach
;         ;                       :handlers     handlers
;         ;                       :before_init  before-init
;         ;                       :capabilities capabilities})
;
;          ; (lsp.cucumber_language_server.setup {:on_attach    on-attach
;          ;                                      :handlers     handlers
;          ;                                      :before_init  before-init
;          ;                                      :capabilities capabilities})
;         ))}]
...
[{1 :neovim/nvim-lspconfig
    :config (fn []
              (let [flutter-tools (require :flutter-tools)
                ...
                ;; Flutter
                (flutter-tools.setup {:lsp {:color {:enable true} :on_attach on_attach}})
