...
[{1 :neovim/nvim-lspconfig
  :lazy false
  :config (fn []
            (let [rustaceanvim (require :rustaceanvim)
              ...
              ;; Rust
              (tset vim.g :rustaceanvim {:server {:on_attach on-attach}})

              ;; odin
              (lsp.glsl_analyzer.setup {:on_attach on-attach
                              : handlers
                              : before_init
                              : capabilities})

              ;; Flutter ; (flutter-tools.setup {:lsp {:color {:enable true} :on_attach on-attach}})
              ;; Fennel
