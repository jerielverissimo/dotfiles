-- [nfnl] Compiled from fnl/plugs/lsp.fnl by https://github.com/Olical/nfnl, do not edit.
...
local function _2_()
  ...
  return rust_tools.setup({server = {on_attach = on_attach}})
end
return {{"neovim/nvim-lspconfig", config = _2_, lazy = false}}
