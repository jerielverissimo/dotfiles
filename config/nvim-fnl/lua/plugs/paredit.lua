...
return {{"julienvincent/nvim-paredit", ft = {"clojure", "fennel"}, config = _2_}, {"julienvincent/nvim-paredit-fennel", dependencies = {"julienvincent/nvim-paredit"}, lazy = true, ft = {"fennel"}, config = _7_}, {"kylechui/nvim-surround", event = "VeryLazy", config = _8_}, {"windwp/nvim-autopairs", event = "InsertEnter", opts = {}}}
