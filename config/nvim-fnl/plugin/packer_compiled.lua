...
_G.packer_plugins = {
  ...
  ["gruvbox-material"] = {
    loaded = true,
    path = "/home/nomad/.local/share/nvim/site/pack/packer/start/gruvbox-material",
  ...
  ["nvim-colorizer.lua"] = {
    loaded = true,
    path = "/home/nomad/.local/share/nvim/site/pack/packer/start/nvim-colorizer.lua",
  ...
  ["vim-sexp"] = {
    loaded = true,
    path = "/home/nomad/.local/share/nvim/site/pack/packer/start/vim-sexp",
