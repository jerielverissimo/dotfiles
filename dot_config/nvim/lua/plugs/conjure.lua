-- [nfnl] fnl/plugs/conjure.fnl
local _local_1_ = require("nfnl.module")
local autoload = _local_1_["autoload"]
local nvim = autoload("nvim")
local function _2_()
  nvim.g["conjure#eval#result_register"] = "e"
  nvim.g["conjure#mapping#log_buf"] = "lo"
